...
<div class="ppb_blog_ticker one nopadding" style="padding: 20px 0 20px 0;">
    <div class="standard_wrapper">
        ...
        <ul id="16549366201450368853" class="newsticker">
            <li>
                <a title="Révolution IA : Une nouvelle puce surpasse ChatGPT et révolutionne l’IA générative !"
                   href="#">
                    Révolution IA : Une nouvelle puce surpasse ChatGPT et révolutionne l’IA générative !</a>
            </li>
            <li>
                <a title="Apple casse les codes avec l’iPhone Ultra : ce que vous devez savoir !" href="#">
            ...
            <li><a title="Meta dévoile des lunettes AR révolutionnaires : la fin des smartphones ?" href="#">
